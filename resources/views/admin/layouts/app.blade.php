        ...
        <nav class="flex-1 px-2.5 py-3 overflow-y-auto sidebar-scroll">
            @php
                ...
                $navGroups = [
                    ...
                    ['label' => 'Penilaian Kinerja', 'icon' => 'workspace_premium', 'key' => 'kpi', 'items' => [
                        ['route' => 'admin.kpi-assessments.index', 'icon' => 'rate_review', 'label' => 'Isi Penilaian', 'match' => 'admin.kpi-assessments.*'],
                        ['route' => 'admin.kpi-cross.index', 'icon' => 'swap_horiz', 'label' => 'Penilaian Silang', 'match' => 'admin.kpi-cross.*'],
                        ['route' => 'admin.kpi-results.index', 'icon' => 'leaderboard', 'label' => 'Hasil KPI', 'match' => 'admin.kpi-results.index'],
                        ['route' => 'admin.kpi-results.trend', 'icon' => 'trending_up', 'label' => 'Tren Antar Periode', 'match' => 'admin.kpi-results.trend'],
                        ['route' => 'admin.kpi-processing.index', 'icon' => 'policy', 'label' => 'Pemrosesan HRD', 'match' => 'admin.kpi-processing.*'],
                        ['route' => 'admin.kpi-calibration.index', 'icon' => 'balance', 'label' => 'Kalibrasi', 'match' => 'admin.kpi-calibration.*'],
                        ['route' => 'admin.kpi-appeals.index', 'icon' => 'gavel', 'label' => 'Sanggahan', 'match' => 'admin.kpi-appeals.*'],
                        ['route' => 'admin.kpi-improvement-plans.index', 'icon' => 'trending_flat', 'label' => 'Rencana Perbaikan', 'match' => 'admin.kpi-improvement-plans.*'],
                        ['route' => 'admin.kpi-periods.index', 'icon' => 'event_repeat', 'label' => 'Periode Penilaian', 'match' => 'admin.kpi-periods.*'],
                        ['route' => 'admin.kpi-cross-matrix.index', 'icon' => 'hub', 'label' => 'Matriks & Penilai Silang', 'match' => 'admin.kpi-cross-matrix.*'],
                        ['route' => 'admin.kpi-relation-graph.index', 'icon' => 'account_tree', 'label' => 'Graf Relasi Divisi', 'match' => 'admin.kpi-relation-graph.*'],
                        ['route' => 'admin.kpi-work-chains.index', 'icon' => 'linear_scale', 'label' => 'Rantai Kerja', 'match' => 'admin.kpi-work-chains.*'],
                        ['route' => 'admin.kpi-indicators.index', 'icon' => 'checklist', 'label' => 'Indikator KPI', 'match' => 'admin.kpi-indicators.*'],
                        ['route' => 'admin.kpi-levels.index', 'icon' => 'stairs', 'label' => 'Level & Bobot', 'match' => 'admin.kpi-levels.*'],
                    ]],
