...
<div class="bg-white rounded-2xl border border-gray-200 shadow-sm max-w-4xl mx-auto overflow-hidden">
    ...
    <div class="px-8 pt-4">
        <table class="w-full text-[12px] border border-gray-300 border-collapse">
            ...
            <tbody>
                {{-- Basic salary (row 0 earnings) + deduction[0] --}}
                <tr class="border-b border-gray-100">
                    ...
                    <td class="px-4 py-2 border-l border-gray-200">{{ $deductions[0]['name'] ?? '' }}</td>
                ...
                <tr class="border-b border-gray-100">
                    ...
                    <td class="px-4 py-2 border-l border-gray-200">{{ $deductions[$i + 1]['name'] ?? '' }}</td>
                ...
                <tr class="border-b border-gray-100">
                    ...
                    <td class="px-4 py-2"></td>
                    <td class="px-4 py-2 border-l border-gray-200">{{ $deductions[$i]['name'] ?? '' }}</td>
