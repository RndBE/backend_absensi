...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 items-stretch">
    <a href="{{ route('admin.reports.attendance') }}" class="group h-full flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div class="p-5 min-h-[148px]">
            ...
            <p class="text-[12px] leading-relaxed text-gray-500">Rekap kehadiran, keterlambatan, dan absensi per karyawan/departemen</p>
        </div>
        <div class="mt-auto px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
    ...
    <a href="{{ route('admin.reports.leave') }}" class="group h-full flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div class="p-5 min-h-[148px]">
            ...
            <p class="text-[12px] leading-relaxed text-gray-500">Rekap pengambilan cuti, sisa cuti, dan riwayat per karyawan</p>
        </div>
        <div class="mt-auto px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
    ...
    <a href="{{ route('admin.reports.overtime') }}" class="group h-full flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div class="p-5 min-h-[148px]">
            ...
            <p class="text-[12px] leading-relaxed text-gray-500">Rekap jam lembur, status approval, dan total per karyawan</p>
        </div>
        <div class="mt-auto px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
    ...
    <a href="{{ route('admin.reports.payroll') }}" class="group h-full flex flex-col bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 overflow-hidden">
        <div class="p-5 min-h-[148px]">
            ...
            <p class="text-[12px] leading-relaxed text-gray-500">Rekap gaji, potongan, pajak, BPJS, dan gaji bersih per periode</p>
        </div>
        <div class="mt-auto px-5 py-3 bg-gray-50 border-t border-gray-100 flex items-center justify-between">
