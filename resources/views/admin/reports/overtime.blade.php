    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            <thead><tr class="bg-gray-50">
                ...
                <th class="px-4 py-2.5 text-center text-[11px] font-bold uppercase text-gray-500 border-b">Total Jam</th>
            </tr></thead>
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2.5 border-b border-gray-100 text-center text-[13px] font-bold text-amber-600">{{ intdiv($os['total_minutes'], 60) }}j {{ $os['total_minutes'] % 60 }}m</td>
                </tr>
                @endforeach
            </tbody>
        </table>
    ...
    <div class="overflow-x-auto">
        <table class="w-full">
            <thead><tr class="bg-gray-50">
                ...
                <th class="px-4 py-2.5 text-left text-[11px] font-bold uppercase text-gray-500 border-b">Karyawan</th>
                <th class="px-4 py-2.5 text-center text-[11px] font-bold uppercase text-gray-500 border-b">Pre-Shift</th>
                <th class="px-4 py-2.5 text-center text-[11px] font-bold uppercase text-gray-500 border-b">Post-Shift</th>
            ...
            <tbody>
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-2 border-b border-gray-100 text-center text-[12px] text-gray-700">{{ $o->pre_shift_duration ?? 0 }}m</td>
                    <td class="px-4 py-2 border-b border-gray-100 text-center text-[12px] text-gray-700">{{ $o->post_shift_duration ?? 0 }}m</td>
                    <td class="px-4 py-2 border-b border-gray-100 text-center text-[12px] font-bold text-amber-600">{{ $o->total_duration_formatted }}</td>
                ...
                @empty
                <tr><td colspan="7" class="text-center py-8 text-gray-400 text-sm">Tidak ada data</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
