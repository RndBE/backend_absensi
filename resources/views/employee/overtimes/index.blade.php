...
<div class="space-y-4">
    <div class="employee-mobile-page-header flex items-start justify-between gap-3">
        ...
        <a href="{{ route('employee.overtimes.create') }}" class="employee-mobile-action inline-flex h-10 shrink-0 items-center justify-center gap-2 px-4 text-[12px] font-bold text-white bg-gradient-to-br from-indigo-600 to-indigo-500 rounded-lg shadow-sm">
